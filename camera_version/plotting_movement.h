...
Rect temp_selection; // Track user rectangular selection TODO: change to polygon shape
Rect selection = Rect(0, 0, 200, 200); // Track user rectangular selection TODO: change to polygon shape
Rect selection_for_event = Rect(10, 10, 20, 20); // Track user rectangular selection TODO: change to polygon shape
IplImage* hull;
CvSize frame_size;
CvSize image_size;
...
CvSeq* contours = 0;
CvMoments *found_moments = (CvMoments*) malloc(sizeof(CvMoments));