...
$CC $CFLAGS -I$INCDIR -I$EXTRAINCDIR1 -I$EXTRAINCDIR2 -I$EXTRAINCDIR3 -L$LIBDIR RaspiCamControl.c RaspiCLI.c RaspiPreview.c RaspiFastCamD.c $LDFLAGS -o raspicam
